...
urlpatterns = [
    ...
    url('users/', include('nomadgram.users.urls')),
    url('images/', include('nomadgram.images.urls')),    
    url('notifications/', include('nomadgram.notifications.urls')),
    url('accounts/', include('allauth.urls')),
    url('', views.ReactAppView.as_view()),
